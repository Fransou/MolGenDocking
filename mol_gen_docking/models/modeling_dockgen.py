...
from transformers.models.qwen3.modeling_qwen3 import KwargsForCausalLM, Qwen3ForCausalLM
...
class DockGenModel(Qwen3ForCausalLM):
    ...
    def __init__(self, config: DockGenConfig, *args: Any, **kwargs: Any) -> None:
    ...
    def from_language_model(
        ...
        **kwargs: Any,
        ...
        model = cls(dock_gen_config, *args, **kwargs)
